...
<template>
  <div style="text-align: center;margin: 0 20px">
    ...
    <div style="margin-top: 50px">
      <el-form :model="form" :rules="rule" ref="formRef">
        <el-form-item prop="username">
          <el-input v-model="form.username" max-length="10" type="text" placeholder="用户名/邮箱">
            <template #prefix>
        ...
        <el-form-item prop="password">
          <el-input v-model="form.password" max-length="20" type="password" placeholder="密码">
            <template #prefix>
    ...
    <el-divider style="font-size: 13px" plain>没有账号</el-divider>
